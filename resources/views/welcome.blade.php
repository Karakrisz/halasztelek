...
<section>
    <div class="about-content">
        ...
        <div class="about-content__img-text-box d-flex">
            ...
            <div class="about-content__img-text-box__div">
                <div class="about-content__img-text-box__div__margin-box">
                    ...
                    <div class="about-content__img-text-box__div__bottom-panel d-flex">
                        <p class="about-content__img-text-box__div__bottom-panel__p">500</p>
                        <p class="about-content__img-text-box__div__bottom-panel__p">325 Ft</p>
                    </div>
                </div>
            </div>
